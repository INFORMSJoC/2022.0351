...
import utils
from utils import STPPS, WeirdNode, dataset
...
cte_config['em_r'] = True    # em_random
...
# ##### Dataset
cte_config['dataset'] = 'e' #''-simulation 'o'-onlien retail 'e'-earthquake 'c'-citibike '9'-911_crime
cte_config['select'] = 100
...
if cte_config['em_kde'] == 0:
    ...
    for i in range(cte_config['round']):
        ...
        if cte_config['dataset']:
            data = dataset(cte_config['dataset'], cte_config['select'])
        else:
